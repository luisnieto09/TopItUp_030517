<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="TopBar.ascx.vb" Inherits="TopItUp.TopBar" %>
                                                    ...
                                                    <td colspan="8">
                                                        <table width="100%">
                                                            <tr>
                                                                ...
                                                                <td   style="height:60px; text-align:center; background-image:url('../Images/Tiraazul.png')">
