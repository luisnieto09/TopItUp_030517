                    ...
                    Try
                        ...
                        If Not tieneservicios Is Nothing Then
                            If tieneservicios.Count() > 0 Then
                                Session("servcol") = "<tr><td class=""auto-style149"">&nbsp;</td><td><img class=""auto-style131"" src=""../Images/puntoOff.png"" runat=""server"" id=""Img1""><span class=""auto-style131""> </span></td><td><a href=""PagoServ.aspx"" runat=""server"" id=""opc1""><span class=""auto-style131"">Pago de Servicios</span></a></td></tr>"
                            Else
                                Session("servcol") = ""
                            End If
                        Else
